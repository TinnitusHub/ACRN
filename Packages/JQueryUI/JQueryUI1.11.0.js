...
$.widget("ui.resizable", $.ui.mouse, {
	...
	_mouseStart: function(event) {
		...
		if (this.options.useOuterSize)
			this.originalSize = this._helper ? { width: el.outerWidth(), height: el.outerHeight() } : { width: el.outerWidth(), height: el.outerHeight() };
		else
			this.originalSize = this._helper ? { width: el.outerWidth(), height: el.outerHeight() } : { width: el.width(), height: el.height() };
...
var menu = $.widget( "ui.menu", {
	...
	_open: function( submenu ) {
		...
		// custom; temp; should find better way
		if (submenu.is(".contextMenu .ui-menu"))
			submenu.css({left: parseInt(submenu.css("left")) + 2, top: parseInt(submenu.css("top")) - 2});
	},
...
var dialog = $.widget( "ui.dialog", {
	...
	_size: function() {
		...
		// custom
		nonContentHeight = this.uiDialog.height() - this.element.height();
