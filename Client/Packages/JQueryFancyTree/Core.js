...
//        node.span.className = cnList.join(" ");
	...
	//nodeSetActive: function(ctx, flag, callOpts) { // custom removed
	nodeSetActive: function (ctx, flag, callOpts, /*optional:*/ triggerEvent) // custom
	{
	    triggerEvent = triggerEvent != null ? triggerEvent : true; // custom
